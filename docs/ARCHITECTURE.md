...
1. Sellers interact with Selly using **control surfaces**. Chat apps like Telegram or Discord, and agent harnesses like Claude Code are examples of control surfaces.
